...
gen:
	docker run -v $(PWD):/build openapitools/openapi-generator-cli:v7.17.0 generate \
		--global-property models,apis,supportingFiles		\
		--generator-name typescript-angular				\
		--config build/apigen.config.json		\
		--input-spec-root-directory /build/.cache/specs 	\
		--output /build/projects/db2rest-client/src/lib/spec
